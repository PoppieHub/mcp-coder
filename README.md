...
Доступные ограничения: `MCP_MAX_AGENT_STEPS` (48), `MCP_MAX_INPUT_CHARS` (12000), `MCP_MAX_FILE_CHARS` (24000), `MCP_MAX_TOTAL_CONTEXT_CHARS` (160000), `MCP_MAX_OUTPUT_TOKENS` (3000), `MCP_REQUEST_TIMEOUT_MS` (60000) `MCP_COMMAND_TIMEOUT_MS` (60000) и `MCP_TASK_TIMEOUT_MS` (600000, 10 минут; диапазон 1000–3600000).
