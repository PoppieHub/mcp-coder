...
Доступные ограничения: `MCP_MAX_AGENT_STEPS` (24), `MCP_MAX_INPUT_CHARS` (12000), `MCP_MAX_FILE_CHARS` (24000), `MCP_MAX_TOTAL_CONTEXT_CHARS` (100000), `MCP_MAX_OUTPUT_TOKENS` (1600), `MCP_REQUEST_TIMEOUT_MS` (60000) и `MCP_COMMAND_TIMEOUT_MS` (60000).
